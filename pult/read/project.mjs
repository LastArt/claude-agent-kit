 ...
 *
 * ПОРЯДОК ЖЁСТКИЙ. Сначала асинхронная проба доступности корня и папки кита в гонке
 * с таймаутом на проект: не ответила — `state: unreachable`, остальные поля `null`, код
 * в списке отказов и НИКАКИХ синхронных чтений дальше.
 *
