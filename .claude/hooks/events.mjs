 ...
 * `gate.mjs` (приёмка взведена, вердикт приёмки) и `session.mjs` (начало и конец сессии).
 * Все трое зовут этот файл ОТДЕЛЬНЫМ процессом и глотают любую ошибку: сбой журнала не имеет
 * права помешать ни смене статуса, ни вердикту приёмки, ни старту сессии.
